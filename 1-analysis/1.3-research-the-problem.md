...
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Unique Bosses (Hollow Knight) | This would be the main focus of my game, each unique boss would be a skill check for the player wich requires a more deep undertanding of the mechanics as the game progresses |
...
| Feature                               | Justification                                                                                                                 |
| ------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| Power ups(Mario)                      | This is very common in platfomer games and is a great way to add complecity and vary level design based around each power up. |
| Warp Zones(Mario)                     | Easy way to transport the player to different areas without having to make enviromental transitions.                          |
| Collectables (Celeste)                | Great way to show progress withing a games and provides and less sourt of progression aside from bosses                       |
| Multiple Difficulty options (Celeste) | Allows for a wider acduince to play the game, as well as making the game easier to ballence for all players                   |
{% endtab %}

{% tab title="Features I wont" %}
| Feature                 | Justification                                                                                    |
| ----------------------- | ------------------------------------------------------------------------------------------------ |
| Multiple endings(Mario) | Time Constraints, Multiple endings require a significant amount of time and effort to implement. |
| Soundtrack (Celeste)    | Same goes for a soundtrack althought it can be very effective there is no need in this project   |
{% endtab %}
{% endtabs %}
